...
public class AskQuestionFragment extends Fragment {
    ...
    private void refer() {
        ...
        int userId = instance.getInt(PrefConstants.U_ID);
        String subject = String.format(getString(R.string.subject_question), user);
        ...
        Call<BaseResponseModel> baseResponseModelCall = ApiClient.getApiInterface().sendHelp(requestModel);
